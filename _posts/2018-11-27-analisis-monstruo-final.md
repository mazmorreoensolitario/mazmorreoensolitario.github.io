...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <table class="table table-striped table-hover">
            ...
            <tr><td>Precio:</td><td><a href="https://amzn.to/2P509zS">24.95€</a></td></tr>
            <tr><td>Número de jugadores:</td><td>2-4</td></tr>
            <tr><td>Nota:</td><td>Existe una variante en solitario</td></tr>
            <tr><td>Tiempo de juego:</td><td>30 mins</td></tr>
            <tr><td>Idioma:</td><td>Castellano</td></tr>
         </table>
        </div>
...
- Elegimos un Monstruo Final del mazo de Monstruo Final, será nuestro
personaje.
